...
_C.TTA = CN()
_C.TTA.ENABLE = False
_C.TTA.METHOD = 'TAFAS'  # TAFAS, CLOSED_FORM
...
_C.TTA.CLOSED_FORM = CN()
_C.TTA.CLOSED_FORM.RANK = 8
_C.TTA.CLOSED_FORM.PREDICTION_MEMORY_SIZE = 64
_C.TTA.CLOSED_FORM.SUPERVISION_BUFFER_SIZE = 32
_C.TTA.CLOSED_FORM.PCA_NORMALIZATION = 'per_trajectory'  # none, per_trajectory
_C.TTA.CLOSED_FORM.MIN_PCA_SAMPLES = 16
_C.TTA.CLOSED_FORM.SUBSPACE_UPDATE_INTERVAL = 8
_C.TTA.CLOSED_FORM.RIDGE_LAMBDA = 0.001
_C.TTA.CLOSED_FORM.FORGETTING_FACTOR = 0.95
_C.TTA.CLOSED_FORM.POGT_LEN = 24
_C.TTA.CLOSED_FORM.RECALCULATE_ACTIVE = True
_C.TTA.CLOSED_FORM.LOG_INTERVAL = 0
